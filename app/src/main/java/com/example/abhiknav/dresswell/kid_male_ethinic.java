...
public class kid_male_ethinic extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kid_male_ethinic, container, false);
        Bitmap[] bitmaps = getBitmaps();
        rvMain1 = (RecyclerView)rootView.findViewById(R.id.rvMain11);
