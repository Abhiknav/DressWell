...
public class teen_female_formal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_teen_female_formal, container, false);
        Bitmap[] bitmaps = getBitmaps();
        rvMain1 = (RecyclerView)rootView.findViewById(R.id.rvMain21);
