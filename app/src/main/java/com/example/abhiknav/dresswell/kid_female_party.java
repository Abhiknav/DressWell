...
public class kid_female_party extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kid_female_party, container, false);
        Bitmap[] bitmaps = getBitmaps();
        rvMain2 = (RecyclerView)rootView.findViewById(R.id.rvMain3);
